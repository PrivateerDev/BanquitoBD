...
const PRODUCTOS = [
  { tipo: 'CUENTA', label: '🏦 Cuenta de Ahorro', desc: 'Sin comisiones, CLABE incluida' },
  { tipo: 'TARJETA', label: '💳 Tarjeta de Débito', desc: 'Acceso a cajeros y compras' },
  { tipo: 'CREDITO_PERSONAL', label: '💰 Crédito Personal', desc: 'Hasta $200,000 a 36 meses' },
  { tipo: 'HIPOTECARIO', label: '🏠 Hipotecario', desc: 'Hasta $5,000,000 a 240 meses' },
  ...
  return (
    <div className="p-8">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Actor: Ejecutivo (tblempleado) · Objeto: tblsolicitudcredito → tblcliente */}
        <TrazabilidadBar
          codes={['RF-CLI-03', 'CU-CLI-03']}
          label="tblsolicitudcredito · estado=EN_EVALUACION"
        />

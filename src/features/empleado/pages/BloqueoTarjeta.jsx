...
export default function BloqueoTarjeta() {
  ...
  useEffect(() => {
    // RF-CLI-05: usa api con interceptor JWT — evita 403 Forbidden
    api.get(`/tarjetas/cliente/${id}`)
  ...
  return (
    <div className="p-8">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Actor: Ejecutivo (tblempleado) · Objeto: tblbloqueotarjeta → tbltarjeta → tblcliente */}
        <TrazabilidadBar
          codes={['RF-CLI-05', 'CU-CLI-04']}
          label="tblbloqueotarjeta · folio=BLQ-YYYY-NNNN · ≤30 s"
        />

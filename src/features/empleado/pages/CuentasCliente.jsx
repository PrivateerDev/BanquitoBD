  ...
  return (
    <div className="p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => navigate(`/clientes/${id}`)}
              className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-4 py-2 rounded-lg text-sm transition-colors shadow-sm">
              📦 Productos
            </button>
            <button onClick={() => navigate(`/clientes/${id}/expediente`)}
              className="bg-blue-700 hover:bg-blue-800 text-white font-semibold px-4 py-2 rounded-lg text-sm transition-colors shadow-sm">
              📁 Expediente
            </button>
          </div>
        </div>
        ...
        {/* Actor: Ejecutivo (tblempleado) · Objetos: tblcuenta, tbltransaccion ← tblcliente */}
        <TrazabilidadBar
          codes={['RF-CLI-01', 'RF-CLI-02', 'RNF-CLI-02']}
          label="tblcuenta (chk_cuenta_saldo_positivo, chk_cuenta_estado, chk_cuenta_tipocuenta) + tbltransaccion"
        />
